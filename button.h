...
public:
    ...
    Button(Point _p1, const char* _str, COLORREF _back_col, COLORREF _text_col):p1(_p1),
                                                                                p2({0, 0}),
                                                                                str(_str),
                                                                                back_col(_back_col),
                                                                                text_col(_text_col)  {
    ...
    Button(Point _p1, Point _p2, const char* _str, COLORREF _back_col, COLORREF _text_col):p1(_p1),
                                                                                           p2(_p2),
                                                                                           str(_str),
                                                                                           back_col(_back_col),
                                                                                           text_col(_text_col) {}
